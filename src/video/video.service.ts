...
export class VideoService implements OnModuleInit {
  ...
  static readonly CATEGORIES: Array<{ label: string; pattern: RegExp; bodyParts: string; wrongBodyParts: string; action: string; environment: string; cameraShot: string }> = [
    ...
    { label: 'Bag, Backpack & Wallet', pattern: /bag|backpack|tote|purse|wallet|pouch|handbag|sling/, bodyParts: 'hands, arms, and upper body', wrongBodyParts: 'feet, lower legs only, face', action: 'opening the bag, placing items inside, zipping it closed, then lifting it over the shoulder', environment: 'bright outdoor street or modern interior', cameraShot: 'medium shot from waist up, showing bag in full' },
    { label: 'Watch & Jewelry', pattern: /watch|bracelet|ring|necklace|jewelry|earring|pendant|bangle/, bodyParts: 'wrist or the body part the item is worn on, with hands briefly', wrongBodyParts: 'feet, legs, item floating without being worn', action: 'putting on the accessory, adjusting the fit, and showing it worn naturally in motion', environment: 'soft natural light indoors, neutral background', cameraShot: 'macro close-up on the worn accessory, slow reveal' },
    ...
    { label: 'Hat & Headwear', pattern: /hat|cap|beanie|bucket hat|beret|snapback|headband/, bodyParts: 'back and top of head with hat on (no face), shoulders visible', wrongBodyParts: 'face shown, hands only without hat on head, hat floating', action: 'hands placing the hat on the head, adjusting the fit, then showing it from different angles', environment: 'outdoor or casual indoor lifestyle setting', cameraShot: 'medium close-up on head and shoulders from behind and sides, no front face' },
    ...
    { label: 'Sunglasses & Eyewear', pattern: /glasses|sunglasses|spectacles|eyewear|eyeglass|frame|lens/, bodyParts: 'side and back of head with glasses on (no front face), hands briefly', wrongBodyParts: 'front face shown, glasses floating, wrong angle revealing face', action: 'hands placing the glasses on, then showing them worn from the side profile and back', environment: 'bright outdoor or well-lit indoor setting', cameraShot: 'side-profile close-up of head wearing glasses, no front face shown' },
    ...
    { label: 'Hair Care & Styling', pattern: /shampoo|conditioner|hair mask|hair oil|hair spray|hair serum|hair brush|comb|hair dryer|straightener|curler|hair/, bodyParts: 'hands and hair (back of head, no face)', wrongBodyParts: 'front face shown, feet, legs, hands without hair visible', action: 'applying or working the product through hair, then showing the finished styled result', environment: 'bathroom or bedroom with natural light', cameraShot: 'medium close-up on hair and hands from behind, slow movement' },
    ...
    { label: 'Headphones & Audio', pattern: /headphone|earphone|earbud|airpod|speaker|bluetooth audio|earpiece/, bodyParts: 'side of head and upper body (no face), hands briefly', wrongBodyParts: 'front face shown, feet, legs, headphones floating', action: 'placing headphones on ears, adjusting fit, then enjoying music during an activity', environment: 'casual indoor or outdoor lifestyle setting', cameraShot: 'side-profile medium close-up on head and shoulders, no front face' },
